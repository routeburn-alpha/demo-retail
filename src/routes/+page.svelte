...
<div data-testid="page-root" class="min-h-screen" style="background-color: #fce4ec">
...
{#if query.trim() === ''}
  <section class="relative isolate overflow-hidden border-b border-line bg-[#0f1a14]">
    ...
    <div class="mx-auto max-w-6xl px-6 py-16 text-bg sm:py-20">
      ...
      <h1 class="font-display text-3xl leading-tight sm:text-4xl md:text-5xl">Built for the long cold Denver winter</h1>
    </div>
  </section>
{/if}
